...
//                   <TextInput label="Company/ Trading name" placeholder="Company/ Trading name" name="company" />
...
//                     </div>
//                   </div>
//                   <TextInput label="Bankers references" placeholder="Bank references" name="bankReference" />
